...
fetch("./data/events.json")
  ...
  .then(events => {
    ...
    events.forEach(event => {
      const shortDesc = event.description.length > 110
      ...
      // set thumbnail src with fallback
      ...
      article.querySelector(".show-desc-btn").addEventListener("click", () => {
        modalBody.innerHTML = `
        ...
        modalImg.onerror = () => { modalImg.src = "./assets/fallback.jpg"; };
